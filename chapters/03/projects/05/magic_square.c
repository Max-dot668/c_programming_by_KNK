/* This program asks the user to enter numbers from 1 to 16 (in any order) and then displays the numbers in a 4 by 4 arrangement */
#include <stdio.h>
...
int main(void)
{
	...
	scanf("%d %d %d %d", &num9, &num10, &num11, &num12);
	scanf("%d %d %d %d", &num13, &num14, &num15, &num16);
